                ...
                <div className="flex flex-wrap gap-2" role="tablist" aria-label="Matter detail">
                  {matterTabs.map((tab) => (
                    <button
                      key={tab}
                      type="button"
                      className={`btn btn-sm min-h-0 border px-3 ${
                        activeTab === tab
                          ? "arena-status arena-status-favorable"
                          : "btn-ghost border-slate-500/30 text-slate-100"
                      }`}
                ...
                <div className="mt-5">
                  {activeTab === "Case File" && (
                    <div className="grid gap-4 lg:grid-cols-2">
                      <div className="arena-console-soft p-4 lg:col-span-2">
                        <p className="font-semibold text-slate-100">Parties</p>
                      ...
                      {hasVerdict ? (
                        <>
                          <div className="arena-console-soft p-4">
                            <div className="flex flex-wrap items-center gap-2">
                              <p className="font-semibold text-slate-100">Final ruling</p>
