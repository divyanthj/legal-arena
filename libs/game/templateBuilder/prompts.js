...
export const buildInterviewPlanningPrompt = ({ basePayload, category, complexity, prompt }) => ({
  ...
  requirements: {
    ...
    rules: [
      ...
      "Each side's suggestedQuestions must be addressed to that side's represented client and answerable from that client's perspective.",
      "Defendant suggestedQuestions must investigate the defense, records, denials, admissions, and response to the claim; never ask the defendant questions meant for the plaintiff.",
      "Plaintiff suggestedQuestions must investigate the claim and requested relief; never ask the plaintiff questions meant for the defendant.",
